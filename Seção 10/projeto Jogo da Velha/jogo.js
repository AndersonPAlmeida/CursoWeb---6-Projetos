    ...
    function () {
        ...
        $('#btn_iniciar_jogo').click(
            function () {
                ...
                // Exibir os apelidos
                $('#nome_jogadort_1').html($('#entrada_apelido_jogador_1').val());
                $('#nome_jogadort_2').html($('#entrada_apelido_jogador_2').val());

                //desabilitando a tela inicial do jogo e habilitando a tela do jogo
                $('#pagina_inicial').hide();
                $('#palco_jogo').show();
            }
        );
        // Pegar posição clicada pelo jogador
        $('.jogada').click(
            function () {
        ...
        // Verifica pontuação dos jogadores
